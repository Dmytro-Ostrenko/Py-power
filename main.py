...
def main():
   ...
   while True:
       ...
       if command == '1':
          ...
          old_contact_name = input('Enter the contact old name you want to remove:')
          new_contact_name = input('Enter the contact new name you want to remove:')
          
          
          print(assistant.edit_contact(old_contact_name, new_contact_name))
